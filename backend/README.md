...
## Project Structure
    ...
    ├── test_imajine_from_f_37586  # Django project configurations
...
1. Clone this repo and `cd test_imajine_from_f_37586`
...
2. Clone this repo and `cd test_imajine_from_f_37586`
